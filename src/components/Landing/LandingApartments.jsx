...
const LandingAparments = ({ backgroundColor, textColor, data, section}) => {
    ...
    return (
        <div id={section} className={`relative bg-${backgroundColor} lg:h-full w-full flex flex-col justify-center items-center pt-20 md:py-12 xl:py-20 4xl:py-32`}>
            <div className={`carousel-container text-center text-${textColor} w-full md:w-[80%] 3xl:w-[60%]`}>
                <h2 className="px-4">{data.title}</h2>
                <p className="px-4 my-8">{data.description.description}</p>
