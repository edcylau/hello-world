...
const LandingContact = () => {
    ...
    return (
        <div className="z-[1] relative w-full overflow-hidden bg-[#c2c6af]">
            ...
            <div className="relative z-10 bg-[#c2c6af] bg-opacity-50 h-full xl:bg-transparent flex justify-center items-center py-20 lg:py-[4.5rem] xl:py-24 2xl:py-32 3xl:py-40 4xl:py-48 px-8">
                    <div className="bg-[#E8BDBB] py-12 xl:bg-transparent md:py-0 mx-auto">
